                ...
                sock.ev.on('connection.update', async (update) => {
                    ...
                    if (connection === 'open') {
                        ...
                        try {
                            ...
                            // ✅ Attendre que le fichier TEMPORAIRE (mis à jour en direct
                            // par creds.update) confirme registered === true AVANT de
                            // copier vers ./session. index.js ne lit QUE ./session/creds.json
                            // pour savoir quand démarrer le bot (hasValidSession) — si on
                            // copie trop tôt, ce fichier reste figé à registered:false et
                            // index.js n'obtient jamais "Bot Connected".
                            //
