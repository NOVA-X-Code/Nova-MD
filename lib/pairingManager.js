          ...
          if (connection === "open") {
            ...
            try {
              ...
              while (attempts < maxAttempts && !registered) {
                ...
                try {
                  // ✅ LIRE DIRECTEMENT LE FICHIER ORIGINAL (dans le dossier temporaire)
                  const originalCredsPath = path.join(
                    data.sessionDir,
                    "creds.json",
                  );
                  ...
                  if (fs.existsSync(originalCredsPath)) {
                    ...
                    if (credsData.registered === true) {
                      ...
                      console.log(
                        "✅ Updated main session with registered credentials",
                      );
