...
const DEFAULT_CONFIG = {
    ...
    provider: 'grok', // 'grok' | 'puter' | 'pollinations' | 'gemini' | 'openai' | 'custom'
    apiKey: '', // MANDATORY — pour Grok: votre clé API xAI
    apiUrl: '', // Pour custom ou pour changer l'URL de Grok
    puterModel: 'gpt-5.4-nano',
    grokModel: 'grok-1', // Modèle Grok
    customContext: '',
    maxHistory: 15,
    temperature: 0.7,
    maxTokens: 1024,
